...
import idusw.springboot.board.entity.QMemberEntity;

import idusw.springboot.board.repository.BoardRepository;
...
public class MemberServiceImpl implements MemberService {
    ...
    private MemberEntity dtoToEntity(MemberDTO member) {
        MemberEntity entity = MemberEntity.builder()
                ...
                .maccess(member.getAccess())
                .address(member.getAddress())
                .mlevel(member.getLevel())
                .build();
        return entity;
    }
    ...
    public MemberDTO entityToDto(MemberEntity entity) {
        ...
        MemberDTO member = MemberDTO.builder()
                ...
                .access(entity.getMaccess())
                .address(entity.getAddress())
                .level(entity.getMlevel())
                .build();
        return member;
    }
